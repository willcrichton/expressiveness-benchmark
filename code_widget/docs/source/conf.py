...
# -*- coding: utf-8 -*-
#
# code_widget documentation build configuration file
#
...
_version_py = os.path.join(repo, 'code_widget', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'code_widgetdoc'
...
latex_documents = [
    (master_doc, 'code_widget.tex', 'code_widget Documentation',
     'Will Crichton', 'manual'),
]
